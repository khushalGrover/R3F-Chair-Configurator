...
export function Chairs_2(props) {
	...
	const { partToMeshMapping, arms, legs, back, cushion, seat } =
		useCustomization();
	...
	return (
		<group {...props} dispose={null} scale={[0.1, 0.1, 0.1]}>
			<mesh
				...
				visible={
					partToMeshMapping["A"] === 1 && partToMeshMapping["A"] !== 0
				}
			>
			...
			<mesh
				...
				visible={
					partToMeshMapping["B"] === 1 && partToMeshMapping["B"] !== 0
				}
			/>
			<mesh
				...
				material={materials.chair}
				visible={
					partToMeshMapping["C"] === 1 && partToMeshMapping["C"] !== 0
				}
			/>
			<mesh
			...
			<mesh
				...
				material={materials.chair}
				visible={
					partToMeshMapping["B"] === 3 && partToMeshMapping["B"] !== 0
				}
			/>
			<mesh
				...
				material={materials.chair}
				visible={
					partToMeshMapping["B"] === 2 && partToMeshMapping["B"] !== 0
				}
			/>
			<mesh
				...
				material={materials.chair}
				visible={
					partToMeshMapping["C"] === 2 && partToMeshMapping["C"] !== 0
				}
			/>
			<mesh
